...
guide: 2021-03-10-cue-kubernetes-tutorial
lang: en
layout: post
...
--- snapshot	2021-05-28 16:42:09.018725443 +0000
+++ snapshot2	2021-05-28 16:42:14.178579100 +0000
@@ -1,3 +1,9 @@
+service: &#123;&#125;
+deployment: &#123;&#125;
+// ---
...
$ diff -wu snapshot snapshot2
--- snapshot	2021-05-28 16:42:14.198578533 +0000
+++ snapshot2	2021-05-28 16:42:36.449947811 +0000
@@ -1,8 +1,14 @@
 service: &#123;&#125;
 deployment: &#123;&#125;
+daemonSet: &#123;&#125;
...
<pre data-command-src="Z28gZ2V0IGs4cy5pby9hcGkvYXBwcy92MQo="><code class="language-.term1">$ go get k8s.io/api/apps/v1
...
-->
<script>let pageGuide="2021-03-10-cue-kubernetes-tutorial"; let pageLanguage="en"; let pageScenario="go115";</script>
